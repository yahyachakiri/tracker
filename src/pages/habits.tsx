...
import { Habits } from '@cards/index';
...
export default function HabitsPage({ data }: props) {
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
    ...
    const fetchData = await fetch(`http://localhost:3000/api/work?from=${today}`);
